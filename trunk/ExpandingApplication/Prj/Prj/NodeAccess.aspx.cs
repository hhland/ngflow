...
public partial class ExpandingApplication_PRJ_NodeRuleUI : WebPage
{
    ...
    {
        this.PubTitle.AddCaptionLeft(" Tree node data access control ");
    ...
    public void BindNodeRule()
    {
        ...
        this.Pub3.AddCaptionLeft(" Tree nodes and data access  - <a href=\"javascript:AddDir('" + this.FK_Flow + "','"+this.FK_Node+"')\" > Add folder </a>");
        ...
        foreach (string dir in dirs)
        {
            ...
            this.Pub3.AddTD("<a href=\"javascript:AddFile('" + idx + "','" + this.FK_Flow + "','" + this.FK_Node + "')\" > Increase Templates </a>");
            this.Pub3.AddTREnd();
            ...
            foreach (FileInfo fl in fls)
            {
                ...
                cb.Text = " You can delete ";
                cb.Checked = rl.IsDelete;
                this.Pub3.AddTD(cb);

                this.Pub3.AddTD("<a href=\"javascript:DelFile('" + idx + "','" + this.FK_Flow + "','" + this.FK_Node + "')\" > Delete </a>");
                this.Pub3.AddTREnd();
            }
        }
    ...
    void btn_Templete_Click(object sender, EventArgs e)
    {
        ...
        string root = BP.SystemConfig.PathOfDataUser + "\\PrjData\\Templete\\" + this.FK_Prj;
        this.Pub3.AddTable();
        this.Pub3.AddCaptionLeft(" Tree nodes and data access ");
        string[] dirs = System.IO.Directory.GetDirectories(root);
        int idx = 0;
        foreach (string dir in dirs)
        {
