/*
 * jQuery Image Carousel ( Focus map ) Plug-in 
...
(function($) {
	$.fn.slideBox = function(options) {
		...
		// Scroll to define the order :ASC/DESC.ADD.JENA.201208081718
		var order_by = 'ASC';
		// Initialization 
		var init = function(){
			if(!wrapper.size()) return false;
			// Manually set the precedence value .ADD.JENA.201303141309
		...
		// After executing initialization debut picture loaded 
