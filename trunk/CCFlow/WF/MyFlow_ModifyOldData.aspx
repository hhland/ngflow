<%@ Page Language="C#" MasterPageFile="WinOpenEUI.master" Title=" Working deal " AutoEventWireup="true" CodeBehind="MyFlow_ModifyOldData.aspx.cs" Inherits="CCFlow.WF.MyFlow_ModifyOldData" %>

<%@ Register Src="MyFlow_ModifyOldDataCol.ascx" TagName="MyFlowUC" TagPrefix="ucCol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ucCol:MyFlowUC ID="ucCol1" runat="server" />
</asp:Content>
