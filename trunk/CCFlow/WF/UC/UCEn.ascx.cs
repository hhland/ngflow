...
namespace CCFlow.WF.UC
{
    ...
    public partial class UCEn : BP.Web.UC.UCBase3
    {
     ...
     "<script language='JavaScript' src='" + CCFlowAppPath + "WF/Comm/kindeditor/kindeditor-all-min.js'  charset='utf-8' ></script>");

            this.Page.RegisterClientScriptBlock("c2",
 "<script language='JavaScript' src='" + CCFlowAppPath + "WF/Comm/kindeditor/lang/en.js'  charset='utf-8' ></script>");
  ...
  "<script language='JavaScript' src='" + CCFlowAppPath + "WF/Comm/kindeditor/plugins/code/prettify.js'  charset='utf-8' ></script>");
    ...
    "<link href='" + CCFlowAppPath + "WF/Comm/kindeditor/themes/default/default.css' rel='stylesheet' type='text/css' />");
            ...
            string strs = "\t\n <script>";
            strs += "\t\n window['kindeditors']=window['kindeditors']||{}; ";
            ...
            strs += "\t\n buttonImageUrl:'"+CCFlowAppPath+"WF/Comm/kindeditor/plugins/multiimage/images/select-files-en.png' ,";
            strs += "\t\n width : '100%',";
       ...
       +" 'anchor', 'link', 'unlink', '|', 'about']" ;
            ...
            strs += "\t\n });" +
                    "\t\n window['kindeditors'][fID]=tem;" +
                    "\t\n var cmd= \"window['kindeditors']['\"+fID+\"'].sync()\";" +
                    "\t\n window.setInterval(cmd, 300);";
            strs += "\t\n });";
