<%@ Page Title=" Trajectories " Language="C#" MasterPageFile="OneWork.master" AutoEventWireup="true"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center',title:'<%=GetGlobalResourceMenu("ChartTrack.Text") %>'" style="overflow-y: hidden;
            padding: 5px">
