        ...
        public void BindFreeModel(BP.Sys.FrmWorkCheck wcDesc)
        {
            ...
            foreach (Node nd in nds)
            {
                if (nodes.Contains(nd.NodeID + ",") == true)
                {
                    ...
                    this.Pub1.AddTD("class='thEvent' style='font-weight:bold;'", " Event ");
                    this.Pub1.AddTD("class='thTime' style='font-weight:bold;'", " Time ");
                    this.Pub1.AddTD("class='thOperator' style='font-weight:bold;'", " The operator ");
                    this.Pub1.AddTD("class='thInformation' style='font-weight:bold;'", " Information ");
                    this.Pub1.AddTREnd();
                    ...
                    foreach (Track tk in tks)
                    {
                        ...
                        if (tk.HisActionType == ActionType.WorkCheck)
                        {
                            ...
                            else
                            {
                                /* Audit information , First output it .*/
                                this.Pub1.AddTR();
                                this.Pub1.AddTD("class='tdEvent'","<img src='../Img/Mail_Read.png' border=0/>" + tk.ActionTypeText);
                                this.Pub1.AddTD("class='thTime' ",tk.RDT);
                                //this.Pub1.AddTD(tk.EmpFromT);

                                if (wcDesc.SigantureEnabel == true)
                                    this.Pub1.AddTD("class='tdOperator'",BP.WF.Glo.GenerUserSigantureHtml(Server.MapPath("../../"), tk.EmpFrom, tk.EmpFromT));
                                else
                                    this.Pub1.AddTD("class='tdOperator'",BP.WF.Glo.GenerUserImgSmallerHtml(tk.EmpFrom, tk.EmpFromT));
                                this.Pub1.AddTDBigDoc("class='tdInformation'",tk.MsgHtml);
                                this.Pub1.AddTREnd();
                                empcheck += tk.EmpFrom;
                            }
                        }
                    ...
                    foreach (SelectAccper item in accepts)
                    {
                        ...
                        this.Pub1.AddTR();
                        this.Pub1.AddTD("class='tdEvent' style='color:Red;'", " Carried out ");
                        //else
                        //this.Pub1.AddTD("style='color:Red;'", " Cc ");
                        this.Pub1.AddTD("class='thTime' style='color:Red;'", "None");

                        //  Show staff to perform .
                        this.Pub1.AddTD("class='tdOperator' style='color:Red;'", BP.WF.Glo.GenerUserImgSmallerHtml(item.FK_Emp, item.EmpName));

                        //info.
                        this.Pub1.AddTD("class='tdInformation' style='color:Red;'", item.Info);
                        this.Pub1.AddTREnd();
                    }
                ...
                else
                {
                    ...
                    this.Pub1.AddTR("style='font-size:14px;font-weight:bold;'");
                    this.Pub1.AddTD("class='thEvent' ", " Event ");
                    this.Pub1.AddTD("class='thTime' ", " Time ");
                    this.Pub1.AddTD("class='thOperator'", " The operator "); 
                    this.Pub1.AddTD("class='thInformation'"," Information ");
                    this.Pub1.AddTREnd();
                    ...
                    foreach (SelectAccper item in accepts)
                    {
                        ...
                        //  Show staff to perform .
                        this.Pub1.AddTD(" class='thOperator' style='color:Red;'", BP.WF.Glo.GenerUserImgSmallerHtml(item.FK_Emp, item.EmpName));

                        //info.
                        this.Pub1.AddTD("class='thInformation' style='color:Red;'", item.Info);
                        this.Pub1.AddTREnd();
                        isHaveIt = true;
                    }
                        ...
                        else
                        {
                            foreach (CCList cc in ccls)
                            {
                                ...
                                else
                                {
                                    ...
                                    this.Pub1.AddTD("None");
                                    this.Pub1.AddTD(BP.WF.Glo.GenerUserImgSmallerHtml(cc.CCTo, cc.CCToName));
                                    this.Pub1.AddTD("class='thInformation'","None");
                                }
                                this.Pub1.AddTREnd();
                            }
                        }
