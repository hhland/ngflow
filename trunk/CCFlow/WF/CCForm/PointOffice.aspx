...
<body onload="InitOffice()">
    ...
    <div style="visibility: hidden; width: 0px; height: 0px">
        <input id="Button3" type="button" value=" Open the file " onclick="OpenWeb()" style="width: 100px;"
        ...
        <input type="button" value=" Insertion process " onclick="WebWordDownFile()" style="width: 100px"
            id="Button1" runat="server" />
        <input type="file" name="TB_Image" id="TB_Image" style="width: 100px" />
        <input type="button" value=" Insert Picture " onclick="InputFiles()" style="width: 100px" id="Button2"
            runat="server" />
        <input type="button" value=" Document Protection " onclick="ProtectDoc()" style="width: 100px;" visible="False"
            id="Btn_ProDoc" runat="server" />
        <input type="button" value=" Unprotect the document " onclick="UnPortectDoc()" style="width: 100px;"
    ...
    <div class="divButton">
        <table style="width: 100%">
            <tr>
                <td>
                    <input type="button" value=" Accept the current revision " onclick="SaveTrack()" style="width: 100px" id="Btn_AttachDoc"
                        runat="server" />
                </td>
                <td>
                    <input type="button" value=" Reject the current revision " onclick="ReturnTrack()" style="width: 100px"
                        id="Btn_UnAttachDoc" runat="server" />
                </td>
                <td>
                    <input type="button" value=" Save " onclick="SaveService()" style="width: 100px" id="Btn_Save"
                        runat="server" />
                </td>
                <td>
                 ...
                 <td>
                    <input type="button" value=" Electronic Signature " onclick="Signature('sealBig')" style="width: 100px" id="Button4"
                        runat="server" />
                </td>
            </tr>
        </table>
