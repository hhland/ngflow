...
namespace CCFlow.WF.Comm.Port
{
    ...
    public class SearchDepts : IHttpHandler
    {
        ...
        /// <summary>
        ///  Get sibling node under the specified parent node 
        /// </summary>
        /// <param name="drResults"> Used to identify the node has been added JSON Collection </param>
        /// <param name="parentNo"> Parent node </param>
        /// <param name="dt"> All nodes Table</param>
        /// <returns></returns>
        ...
        /// <summary>
        ///  Gets all the child nodes under the specified node 
        /// </summary>
        /// <param name="drResults"> Used to identify the node has been added JSON Collection </param>
        /// <param name="no"> Node </param>
        /// <param name="dt"> All nodes Table</param>
        /// <returns></returns>
