...
namespace CCFlow.WF.Comm
{
    public partial class SelectMVals : BP.Web.WebPage
    {
        ...
        public void BindEnum(UserRegedit ur, Attr attr, string cfgVal)
        {
            ...
            this.Pub1.AddCaptionLeft(" Please select one or more of them ");
            this.Pub1.AddTR();
            this.Pub1.AddTDTitle("IDX");

            this.Pub1.Add("<TD class=Title>");
            this.Pub1.Add("<input type=checkbox text=' Select all ' name=checkedAll onclick='SelectAll()' > Select all ");
        ...
        public void BindEns(UserRegedit ur, Attr attr, string cfgVal)
        {
            ...
            this.Pub1.AddCaptionLeftTX(" Please select one or more of them ");
            this.Pub1.AddTR();
            this.Pub1.AddTDTitle("IDX");
            ...
            this.Pub1.Add("</TD>");
            //this.Pub1.AddTDTitle("<input type=checkbox   text=' Select all ' name=checkedAll onclick='SelectAll()' > Select all ");
            this.Pub1.AddTREnd();
