...
namespace CCFlow.Web.Comm
{
    ...
    public partial class UIRefMethod1 : BP.Web.PageBase
    {
        ...
        public void btn_Do_Click(object sender, EventArgs e)
        {
                        ...
                        case UIContralType.TB:
                            switch (attr.MyDataType)
                            {
                                ...
                                case BP.DA.DataType.AppBoolean:
                                    ...
                                    break;
                                default:
                                    throw new Exception(" Does not determine the type of data го");
                            }
                            break;
            ...
            {
                this.UCEn1.AddMsgOfWarning("@ Carried out [" + ensName + "] An error occurred during :",
                    ex.Message);
            }
            return;
        }
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            Method rm = BP.En.ClassFactory.GetMethod(ensName);
            if (rm == null)
                throw new Exception("@ Method name wrong or the method does not exist :"+ensName);
            this.Bind(rm);
        }
        public void Bind(Method rm)
        {
            this.UCEn1.AddFieldSet("<b> Function execution :" + rm.Title + "</b>");
            this.UCEn1.AddBR();
            ...
            this.UCEn1.Add("<input type=button class=Btn onclick='window.close();' value=' Shut down (Esc)' />");
