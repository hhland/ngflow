...
namespace CCFlow.WF.Comm.RefFunc
{
    public partial class RefDtl : BP.Web.UC.UCBase3
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    this.ToolBar1.AddLinkBtn(NamesOfBtn.Excel, " Export Excel");
        ...
        public void Bind()
        {
            ...
            //this.ucsys1.AddTRSum();
            //this.ucsys1.AddTD("colspan=2", " Total ");
            //foreach (Attr attr in attrs)
            //{
            //    if (attr.UIVisible == false)
            //        continue;
        ...
        public void Save(bool isclose)
        {
            ...
            foreach (Entity dtl in dtls)
            {
                ...
                {
                    msg += "@ In the Save (" + idx + ") OK Error :" + ex.Message;
                }
            }
            ...
            if (en.IsBlank == false)
            {
                ...
                {
                    msg += "@ Insert a new row in error :" + ex.Message;
                }
            }
