...
<HTML>
	<HEAD>
		<title> Thank you for choosing :<%=BP.SystemConfig.DeveloperShortName%>
			->  List </title>
				...
				<TR  valign="top" height='100%'>
					<TD vAlign="top" noWrap width='20%'>
						<TABLE  id="Table1"   width='100%' height="0%" border=0 >
							<TR>
								<TD  class="GroupTitle"  > For comparison </TD>
							</TR>
							<TR>
								<TD>
							...
							<TR>
								<TD  class="GroupTitle"  > Classification Conditions :</TD>
							</TR>
							<TR>
								<TD><cc1:DDL id="DDL_Key" runat="server"></cc1:DDL></TD>
							</TR>
							<TR>
								<TD class="GroupTitle" > Analysis Project </TD>
							</TR>
							<TR>
								<TD>
							...
							<TR>
								<TD class="GroupTitle" > Analytical methods </TD>
							</TR>
							<TR>
