...
namespace CCFlow.Web.Comm.UC
{
    ...
    public partial class UCEn : BP.Web.UC.UCBase3
    {
        ...
        public void BindAttrs(Attrs attrs)
        {
            ...
            foreach (Attr attr in attrs)
            {
                ...
                else if (attr.UIContralType == UIContralType.DDL)
                {
                    ...
                    {
                        /*  In the case of  DDLIsEnable µÄ,  We must find . */
                        if (attr.MyFieldType == FieldType.Enum)
                        {
                            /*  In the case of  enum  Type  */
                            int enumKey = 0;
                            try
                            {
                            ...
                            {
                                throw new Exception(" The default value error :" + attr.Key + " = " + val.ToString());
                            }
                        ...
                        else
                        {
                            ...
                            catch
                            {
                                ...
                                {
                                    lab = "" + val.ToString();
                                    //lab=" Is not associated with a value "+val.ToString()+"Class="+attr.UIBindKey+"EX="+ex.Message;
                                }
                            }
        ...
        public void Bind3Item(Entity en, bool isReadonly, bool isShowDtl)
        {
            ...
            #region  View contains  MyFile If the field is considered to be accessories .
            if (en.EnMap.Attrs.Contains("MyFileName"))
            {
                ...
                this.AddTR();
                this.AddTD("align=right nowrap=true class='FDesc'", " Attachments or pictures :");
                ...
                if (fileExt != "")
                {
                    ...
                    btn1.Attributes["onclick"] += " return confirm(' To perform this operation to remove attachments or pictures , Whether to continue ?');";
                    this.Add(btn1);
                }
                this.Add("</TD>");
        ...
        #region  Binding v2.  Liuxian Chen modification  2014-10-14.
        /// <summary>
        ///  Binding properties of all nodes , Use EasyUI To layout 
        /// </summary>
        /// <param name="en"></param>
        ...
        public void BindV2(Entity en, string enName, bool isReadonly, bool isShowDtl, string noKey)
        {
            ...
            string[] gTitles = cf.GroupTitle.Split('@'); //  Get Packet Label .
            int idxL1, idxL2;
            string tabTitle;
            var idx = 0;
            ...
            // Seek out the relevant fields and function keys .
            ...
            foreach (var de in dictGroups)
            {
                ...
                // Removal English / Chinese content in parentheses , Before heading to display only the contents of the brackets , The title is too long to prevent 
                if (idxL1 > 0)
            ...
            // Before displaying the processed save open tabs , The increase in hidden fields , Record labels currently open title
            // After saving event processing , Get the hidden domain record label title, The title Added to redirectµÄurl Parameters , In the front page of JS Capture title, Check the label 
            ...
            foreach (var g in dictGroups)
            {
                ...
                foreach (Attr attr in attrs)
                {
                    ...
                    #region  Determine whether the single display 
                    if (attr.UIIsLine)
                    {
                        if (isLeft == false)
                        {
                        ...
                        if (attr.UIHeight != 0)
                        {
                            /* Chunks of text collection ,  Special treatment .*/
                        ...
                        switch (attr.UIContralType)
                        {
                            case UIContralType.TB:
                                ...
                                if (attr.Key == noKey && attr.UIIsReadonly == false && attr.UIVisible == true)
                                {
                                    ...
                                    //string helpScript = "";
                                    string helpScript = "<a href=\"javascript:alert(' Please double-click on the text box , Find window will appear .');\" ><img src='./Img/Btn/Search.gif' border=0 /></a>";
                    ...
                    #endregion  Determine whether the single display  //  To end the case of single-line display .
                    ...
                    #region  Increased field related functions .
                    if (rmKeys.Contains("," + attr.Key + ",") == true)
                    {
                        #region  Create a connection string .
                        string html = "";
                    ...
                    #endregion  Increased field related functions .
                ...
                if (en.EnMap.Attrs.Contains("MyFileName"))
                {
                    ...
                    if (fileExt != "")
                    {
                        ...
                        btn1.Attributes.Add("class", "Btn1");
                        btn1.ID = "Btn_DelFile";
                        btn1.Attributes["onclick"] += " return confirm(' To perform this operation to remove attachment , Whether to continue ?');";
                        this.Add(btn1);
                    }
                    this.AddTDEnd();
                    this.AddTREnd();
                } // End packet circulating within the fields .
                #endregion
            ...
            #region  Binding properties of the control .
            this.AddTable();
            ...
            foreach (AttrFile attrF in fileAttrs)
            {
                ...
                /*  To determine whether there is no file on the file to remove it .*/
                ...
                else
                {
                    ...
                    btn_m.Attributes["onclick"] += " return confirm(' To perform this operation to remove attachment , Whether to continue ?');";
                    this.Add(btn_m);
                    this.AddTDEnd();
                }
                this.AddTREnd();
            }
            #endregion  Binding properties of the control .
            ...
            if (en.EnMap.Attrs.Contains("MyFileNum"))
            {
                ...
                if (en.PKVal == null || en.PKVal == "" || en.PKVal == "0")
                    this.Add("<TD  colspan=3 ><a href=\"javascript:alert(' Please execute after saving .');\" target=_self> Bulk upload attachments ( Please execute after saving )</a></TD>");
                else
                    this.Add("<TD  colspan=3 ><a href=\"../FileManager.aspx?EnName=" + en.ToString() + "&PK=" + en.PKVal + "\" target=_self > Bulk upload attachments & Editor </a></TD>");
                this.AddTREnd();
            }
            this.AddTableEnd();
            if (isShowDtl == false)
            ...
            {
                string endMsg = "";
                //  Increase related information 
                AttrsOfOneVSM oneVsM = en.EnMap.AttrsOfOneVSM;
                foreach (AttrOfOneVSM vsM in oneVsM)
                    endMsg += "[<a href=\"javascript:alert(' Please fill in the preservation .');\" >" + vsM.Desc + "</a>]";
                ...
                foreach (RefMethod func in myreffuncs)
                {
                    if (func.Visable == false)
                        continue;
                    endMsg += "[<a href=\"javascript:alert(' Run after saving .');\" >" + func.Title + "</a>]";
                }
                ...
                if (isShowDtl)
                {
                    EnDtls enDtls = en.EnMap.Dtls;
                    foreach (EnDtl enDtl in enDtls)
                        endMsg += "[<a href=\"javascript:alert(' Please fill in the preservation .')\" >" + enDtl.Desc + "</a>]";
                }
