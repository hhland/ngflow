...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="toolBar">
        <div id="top">
            <asp:Button ID="Btn_Save" runat="server" Text=" Save " Width="60" OnClick="Btn_Save_Click" />
            <asp:Button ID="Btn_Column" runat="server" Text=" Set the list of properties " Width="100" OnClick="Btn_Column_Click" />
        </div>
    </div>
