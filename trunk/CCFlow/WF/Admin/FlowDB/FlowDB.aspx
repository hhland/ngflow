<%@ Page Title=" Process Monitoring " Language="C#" MasterPageFile="../WinOpen.master" AutoEventWireup="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function openSelectEmp(hid, tid) {
            ...
            OpenEasyUiDialog(url, 'eudlgframe', ' Select sponsors ', 520, 360, 'icon-user', true, function (ids) {
                var arr = ids.split(',');
                var hiddenId = arr[0];
                var tbId = arr[1];
        ...
        function openSelectDept(hid, tid) {
            ...
            OpenEasyUiDialog(url, 'eudlgframe', ' Select Sector ', 520, 360, 'icon-department', true, function (ids) {
                var arr = ids.split(',');
                var hiddenId = arr[0];
                var tbId = arr[1];
