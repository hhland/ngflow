...
namespace CCFlow.WF.Rpt
{
    public partial class WF_Rpt_Bill : BP.Web.WebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #region  Processing the query set of default .
            if (this.DoType == "My")
            {
                ...
                foreach (AttrSearch attr in searchs)
                {
                    ...
                    switch (attr.Key)
                    {
                        case "FK_Emp":
                            ...
                            mydll.Items.Clear();
                            mydll.Items.Add(new ListItem("=> Print People ", "all"));
            ...
            #endregion  Processing the query set of default .
        ...
        public Entities SetDGData(int pageIdx)
        {
            ...
            if (maxPageNum > 1)
                this.Pub2.Add(" Flip key :← → PageUp PageDown");
        ...
        public void BindEns(Entities ens, string ctrlId)
        {
            ...
            #region  Data output .
            this.UCSys1.AddTDTitle(" Function ");
            ...
            foreach (Entity en in ens)
            {
                ...
                // Related functions .
                string ext = "";
                ext += "<a href=\"javascript:WinOpen('Bill.aspx?DoType=Print&MyPK=" + en.PKVal + "','tdr');\" ><img src='./../Img/book.gif' /> Print </a>";
                ext += "-<a href=\"javascript:WinOpen('../Chart.aspx?FK_Flow=" + this.FK_Flow + "&WorkID=" + en.GetValStringByKey("WorkID") + "&FID=" + en.GetValStringByKey("FID") + "','tr');\" ><img src='./../Img/track.png' /> Trajectories </a>";
                // ext += "-<a href=\"javascript:WinOpen('./../WFRpt.aspx?FK_Flow=" + this.FK_Flow + "&WorkID=" + en.GetValStringByKey("WorkID") + "&FID=" + en.GetValStringByKey("FID") + "','tdr');\" > Report </a>";
            ...
            try
            {
                ...
                switch (btn.ID)
                {
                    ...
                    case NamesOfBtn.Excel: // Export Data 
                        ...
                        this.SetDGData();
                        return;
                    case NamesOfBtn.Excel_S: // Export Data .
                        ...
                        this.SetDGData();
                        return;
                    case NamesOfBtn.Xml: // Export Data 
                        return;
                    case "Btn_Print":  // Export Data .
                        return;
                    default:
                        this.PageIdx = 1;
                        this.SetDGData(1);
