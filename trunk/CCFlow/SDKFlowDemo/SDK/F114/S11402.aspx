<%@ Page Title=" Child thread " Language="C#" MasterPageFile="~/SDKFlowDemo/SDK/Site.Master" AutoEventWireup="true" CodeBehind="S11402.aspx.cs" Inherits="CCFlow.SDKFlowDemo.SDK.F114.S11402" %>
...
<div id="Msg" />
 Child thread - Sales processing tasks 
...
<fieldset>
<legend> Sub-process component </legend>
    <uc4:SubFlowDtl ID="SubFlowDtl1" runat="server" />

    <fieldset>
    <legend> Call the sub-processes 115</legend>
    <% string workid=this.Request.QueryString["WorkID"]; %>
    <% string pFID=this.Request.QueryString["FID"]; %>
    <a href="/WF/MyFlow.aspx?PFlowNo=114&PNodeID=11402&PWorkID=<%=workid %>&PFID=<%=pFID %>&FK_Flow=115&FK_Node=11501" target="_blank" > Sponsored sub-processes </a>
    </fieldset>
