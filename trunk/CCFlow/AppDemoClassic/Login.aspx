<%@ Page Language="C#" AutoEventWireup="true" Inherits="AppDemo_Login123" CodeBehind="Login.aspx.cs" %>
...
<body> 
    ...
    <footer id="footer" class="footer">
		<div class="footer-inner" id="footerInner">			
			<nav class="footerNav">
                <a href="http://ccflow.org/" target="_blank"> Official Website </a>&nbsp;
                <a href="http://weibo.com/signup/signup.php?inviteCode=1618274127" target="_blank"><img src="Img/ico_sina_weibo.gif" />@ Sina Weibo </a>
                <a href="http://t.qq.com/hiflow" target="_blank"> <img src="Img/ico_tx_weibo.gif" /> @ Tencent microblogging  </a>
                | Jinan gallop Information Technology Co., Ltd. All rights reserved  &copy; 2003-2014</span>&nbsp;&nbsp; Tel :0531-82374939
			</nav>
		</div>
	</footer>
    </form>
