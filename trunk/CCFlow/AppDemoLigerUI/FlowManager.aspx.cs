...
{
    public partial class FlowManager : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            btnReturn.Value = GetGlobalResourceButton("Search.Text");
        }
        ...
        private void Delete()
        {
            ...
            {
                str = " Incoming parameter is incorrect ";
            }
            else
            {
                try
                {
                    ...
                    if (info.Equals(" Deleted successfully "))
                    {
                        str = "True";
                    }
                    else
