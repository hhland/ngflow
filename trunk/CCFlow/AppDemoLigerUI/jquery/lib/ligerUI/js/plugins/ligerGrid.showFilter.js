// Expand  ligerGrid 的  Search ( Advanced custom queries ). Application : demos/filter/grid.htm
$.ligerui.controls.Grid.prototype.showFilter = function () {
    ...
    //将grid的columns Converted to filter的fields
    function getFields() {
        var fields = [];
        // If the multi-header , Then g.columns The lowest level of the column 
