...
/**//* 
*     Message unload event , You can rewrite  
*/
POP_Message.prototype.onunload = function () {
    return true;
}
/**//* 
* // To modify the   Inbox    Connection 
*/
POP_Message.prototype.oncommand = function () {
    ...
    if (mesCount > 1) {
        ...
        //window.open("../AppDemoLigerUI/SmsList.aspx?type=unRead", " Unread list ", "width: 200,height:400");
        //f_addTab('SmsList', ' System Messages ', 'SmsList.aspx')
        tab.addTabItem({ tabid: 'SmsList', text: ' System Messages ', url: 'SmsList.aspx' });
    }
    else {
        var myPK = document.getElementById("messagemyPK").value;
        $.ligerDialog.open({ height: 400, url: '../AppDemoLigerUI/SmsListDetail.aspx?MyPK=' + myPK, width: 450, showMax: true, showToggle: true, showMin: true, isResize: true, modal: false, title: ' Message Details ' });
...
POP_Message.prototype.show = function () {
    ...
    str += "<SPAN title= Shut down  style='FONT-WEIGHT: bold; FONT-SIZE: 12px; CURSOR: hand; COLOR: red; MARGIN-RIGHT: 4px' id='btSysClose' >×</SPAN></TD>"
    str += "</TR>"
    str += "<TR>"
