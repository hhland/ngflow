function getLodop(oOBJECT, oEMBED) {
    ...
    **************************/
    var strHtmInstall = "<br><font color='#FF00FF'> Print control is not installed ! Click here <a href='Lodop/install_lodop32.exe' target='_self'> Installation </a>, Please refresh the page after the installation or re-enter .</font>";
    var strHtmUpdate = "<br><font color='#FF00FF'> Print controls need to be upgraded ! Click here <a href='Lodop/install_lodop32.exe' target='_self'> Perform the upgrade </a>, Please re-enter after upgrade .</font>";
    var strHtm64_Install = "<br><font color='#FF00FF'> Print control is not installed ! Click here <a href='Lodop/install_lodop64.exe' target='_self'> Installation </a>, Please refresh the page after the installation or re-enter .</font>";
    var strHtm64_Update = "<br><font color='#FF00FF'> Print controls need to be upgraded ! Click here <a href='Lodop/install_lodop64.exe' target='_self'> Perform the upgrade </a>, Please re-enter after upgrade .</font>";
