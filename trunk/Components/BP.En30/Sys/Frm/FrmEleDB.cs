    ...
    public class FrmEleDB : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = " Extended form elements DB";
                map.EnType = EnType.Sys;

                map.AddMyPK();
                map.AddTBString(FrmEleDBAttr.FK_MapData, null, "FK_MapData", true, false, 1, 30, 20);
                map.AddTBString(FrmEleDBAttr.EleID, null, "EleID", true, false, 0, 200, 20);
                map.AddTBString(FrmEleDBAttr.RefPKVal, null, "RefPKVal", true, false, 0, 200, 20);
