...
namespace BP.WF
{
    ...
    public class Dev2Interface
    {
            ...
            string flowNo, Int64 nodeID, Int64 workID, Int64 fid)
        {
            if (workID != 0)
            {
                string url = Glo.HostURL + "WF/Do.aspx?ActionType=OF&SID=" + userNo + "_" + workID + "_" + nodeID;
                url = url.Replace("//", "/");
                url = url.Replace("//", "/");

                msgDoc += " <hr> Open Work : <a href='"+url+"'>" + url+"</a>";
            }
        ...
        {
            Port_SendMsg(sendTo, mailTitle, mailDoc, smsInfo, msgFlag, msgType,
        flowNo, nodeID, workID, fid, isEmail, isSMS, "");
        }
        ...
        public static void Port_SendMsg(string sendTo, string mailTitle, string mailDoc, string smsInfo, string msgFlag, string msgType,
            string flowNo, Int64 nodeID, Int64 workID, Int64 fid, bool isEmail, bool isSMS,string mailUrlsPatterns)
        {
            SMS sms = new SMS();
            ...
            sms.Title = mailTitle;
            string urlHtml =
                string.Format(mailUrlsPatterns
                              ,Glo.HostURL.Trim('/')
                              ,flowNo
                              ,nodeID
                              ,workID
            ...
            sms.DocOfEmail = mailDoc+urlHtml;
            if (isEmail == true)
                sms.HisEmaiSta = MsgSta.UnRun;
            else
        ...
        {
            return Node_ReturnWork(fk_flow,  workID,  fid,  currentNodeID,  returnToNodeID,
             returnToEmp,  msg, isBackToThisNode,null);
        }
        ...
        public static string Node_ReturnWork(string fk_flow, Int64 workID, Int64 fid, int currentNodeID, int returnToNodeID,
            string returnToEmp, string msg, bool isBackToThisNode,string msgTitlePattern)
        {
            //  Converted into numbers .
            fk_flow = TurnFlowMarkToFlowNo(fk_flow);
            WorkReturn wr = new WorkReturn(fk_flow, workID, fid, currentNodeID, returnToNodeID, returnToEmp, isBackToThisNode, msg);
            if (msgTitlePattern != null) wr.MsgTitlePattern = msgTitlePattern;
            return wr.DoIt();
        }
