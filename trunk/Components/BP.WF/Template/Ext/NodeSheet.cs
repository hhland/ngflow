    ...
    public class NodeSheet : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                str += "@6=07.Same as previous node user";
                str += "@7=08.Same as node Starter";
                ...
                map.AddTBString(NodeAttr.DeliveryParas, null, " Access Rules set content ", true, false, 0, 500, 10, false);
