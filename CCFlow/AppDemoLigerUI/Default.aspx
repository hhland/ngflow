    ...
    <script type="text/javascript">
        ...
        function callBack(js) {
            if (typeof (js) == "string") {
                ...
                document.getElementById("empworkCount").innerHTML = " Upcoming (" + pushData.message.empwork + ")";
                document.getElementById("ccsmallCount").innerHTML = " Cc (" + pushData.message.ccnum + ")";
                document.getElementById("hungUpCount").innerHTML = " Pending (" + pushData.message.hungupnum + ")";
                if (document.getElementById("TaskPoolNum") != null)
                    document.getElementById("TaskPoolNum").innerHTML = " Shared mission (" + pushData.message.TaskPoolNum + ")";
            }
        }
...
<body style="padding: 0px; background: #EAEEF5;" onload="checktop();">
    ...
    <div id="layout1" style="width: 99.2%; margin: 0 auto; margin-top: 4px;">
        <div position="left" title=" Menu " id="accordion1" runat="server">
        </div>
