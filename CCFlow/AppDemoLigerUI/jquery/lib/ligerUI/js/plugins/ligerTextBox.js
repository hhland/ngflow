...
(function ($)
{
    ...
    $.ligerDefaults.TextBox = {
        ...
        width: null,
        disabled: false,
        value: null,     // Initialization value  
        nullText: null,   // Tips can not be empty 
        digits: false,     // Is defined as a digital input box 
        number: false    // Floating-point format is limited to the input box 
    };
