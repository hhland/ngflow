...
namespace CCFlow.AppDemoLigerUI
{
    public partial class MonthPlanRePort : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.monthReport.AddTDTitle(thStyle+" width='5%'", " No. ");
            this.monthReport.AddTDTitle(thStyle + " width='10%'", " Program Category ");
            this.monthReport.AddTDTitle(thStyle + " width='10%'", " Work Item ");
            this.monthReport.AddTDTitle(thStyle, " Job content and requirements ");
            this.monthReport.AddTDTitle(thStyle + " width='10%'", " Completion Time ");
            this.monthReport.AddTDTitle(thStyle + " width='10%'", " Responsible departments ");
            this.monthReport.AddTDTitle(thStyle + " width='10%'", " With the department ");
            this.monthReport.AddTDTitle(thStyle + " width='10%'", " Inspection department ");
        ...
        void exportexcel()
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment;filename=" + HttpUtility.UrlEncode(" Month plan summary .xls", Encoding.UTF8).ToString());
        ...
        void exportword()
        {
            ...
            Response.Buffer = true;
            Response.Charset = "utf-8";
            Response.AppendHeader("Content-Disposition", "attachment;filename=" + HttpUtility.UrlEncode(" Month plan summary .doc", Encoding.UTF8).ToString());
            Response.ContentEncoding = System.Text.Encoding.GetEncoding("utf-8");
        ...
        private string RedContro()
        {
            ...
            return result;// Returns control HTML Code  
        }
    }
}