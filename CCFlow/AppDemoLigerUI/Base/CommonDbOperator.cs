...
namespace CCFlow.AppDemoLigerUI.Base
{
    ...
    public class CommonDbOperator
    {
        ...
        /// <summary>
        ///  Temporarily for datatable Serialized as json The earth approach 
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        ...
        /// <summary>
        ///  Deal with Json Special characters 
        /// </summary>
        ...
        private static string ChangeJsonValue(object value)
        {
            ...
            // This is due to multiple conflicting escape character , So first into temporary tag 
