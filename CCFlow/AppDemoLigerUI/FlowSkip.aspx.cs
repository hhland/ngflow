    ...
    public partial class FlowSkip : System.Web.UI.Page
    {
        ...
        protected void Btn_OK_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               BP.WF.Dev2Interface.WriteTrack(this.FK_Flow, nd.NodeID, this.WorkID, work.FID,note, ActionType.Shift, null, null, " Jump ");
                //  Prompt .
                BP.Sys.PubClass.Alert(" Jump to have successfully :" + str + ", Go to :" + nd.Name+","+info );
