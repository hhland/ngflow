            ...
            try
            {
                ...
                switch (this.ActionType)
                {
                    ...
                    case "DelSubFlow": // Removal process .
                        try
                        {
                            BP.WF.Dev2Interface.Flow_DeleteSubThread(this.FK_Flow, this.WorkID);
                            this.WinClose();
                        }
                        catch (Exception ex)
                        {
                    ...
                    case "Track": // To open a work by a string .
                         ...
                         this.Response.Write("<script> window.location.href='" + myurl + "'</script> *^_^*  <br><br> Are entering the system. Please wait , If nothing happens for a long time ,Çë<a href='" + myurl + "'> Click here to enter .</a>");
                        return;
                    case "OF": // To open a work by a string .
