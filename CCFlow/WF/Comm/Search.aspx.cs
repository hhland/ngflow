...
namespace CCFlow.Web.Comm
{
    ...
    public partial class Search : BP.Web.WebPage
    {
        ...
        #region  Loading method . Page_Load
        protected void Page_Load(object sender, System.EventArgs e)
        {
           ...
           "<link href='./Style/Table" + BP.Web.WebUser.Style + ".css' rel='stylesheet' type='text/css' />");
            ...
            #region  Set up toolbar2 µÄ contral   Setting the search function .
      ...
      "<input type=button id='ToolBar1$Btn_New' class=Btn name='ToolBar1$Btn_New' onclick=\"javascript:ShowEn('./RefFunc/UIEn.aspx?EnsName=" + this.EnsName + "','cd','" + BP.Sys.EnsAppCfgs.GetValInt(this.EnsName, "WinCardH") + "' , '" + BP.Sys.EnsAppCfgs.GetValInt(this.EnsName, "WinCardW") + "');\"  value=' New (N)'  />");
        ...
        #endregion  Loading method . Page_Load
        ...
        public Entities SetDGData(int pageIdx)
        {
            ...
            try
            {
                ...
                if (maxPageNum > 1)
                    this.UCSys2.Add(" Flip key :¡û ¡ú PageUp PageDown");
            }
            catch
            {
                try
        ...
        private void ToolBar1_ButtonClick(object sender, System.EventArgs e)
        {
            try
            {
                ...
                switch (btn.ID)
                {
                    case NamesOfBtn.Insert: // Export Data 
