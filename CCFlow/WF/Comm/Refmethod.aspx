...
<html>
<head>
    <title>Esc  Button to close the window .</title>
...
<body onkeypress="javascript:Esc();" leftmargin="0" topmargin="0">
    ...
    <table id="Table1" cellspacing="1" cellpadding="1" width="100%" border="1" class="Table"
       ...
       <caption class=ToolBar >
        ...
        <tr>
            <td class="TD">
                <asp:Button ID="btnSave" runat="server" Text=" Carried out " OnClick="BPToolBar1_ButtonClick" />
                <asp:Button ID="btnClose" runat="server" Text=" Shut down " OnClick="btnClose_Click" />
            </td>
        </tr>
        <tr>
            <td class="TD">
