    ...
    <div data-options="region:'center'" style="padding: 0px;" border="false"
        ...
        <div id="tb" style="padding: 3px;">
            <div id="Div1" runat="server" style="height:30px;">
                ...
                <a id="querybtn" href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" runat="server" onserverclick="ToolBar1_ButtonClick"> Inquiry </a>
                </div>
                <div class="datagrid-btn-separator"></div>
                <a id="newWin" href="#" style="float:left;" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-new'"
                    onclick="CreateEntityForm()"> New </a> 
                <a id="editWin" href="#" style="float:left;" class="easyui-linkbutton"
                        data-options="plain:true,iconCls:'icon-config'" onclick="EditEntityForm()"> Modification </a>
                <a id="delSelected" href="#" style="float:left;" class="easyui-linkbutton"
                        data-options="plain:true,iconCls:'icon-delete'" onclick="DelSelected()"> Delete </a>
            </div>
        </div>
