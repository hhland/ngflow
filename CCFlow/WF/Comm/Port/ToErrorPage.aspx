	...
	<body class="Body<%=BP.Web.WebUser.Style%>"  onkeypress="Esc()" >
		<form id="ErrPage" method="post" runat="server">
				...
				<TABLE id="Table1" align="center" height='80%' cellSpacing="1" cellPadding="1" width="95%"
					...
					<TBODY>
						<TR bgColor="#ff9900" height="0">
							<TD style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid; HEIGHT: 24px"><FONT face=" Times New Roman "><FONT face=" Times New Roman "><p align="center"><STRONG>&nbsp; Message :&nbsp;</STRONG>
									</FONT></P></FONT>
			</FONT></TD></TR>
			...
			<TR bgColor="#ff9900" height="0" align="center">
				<TD valign="top" height="0"><FONT face=" Times New Roman " color="#000066" size="2">
