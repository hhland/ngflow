				...
				<TABLE id="Table1" align="center" height='80%' cellSpacing="1" cellPadding="1" width="95%"
					...
					<TBODY>
						<TR bgColor="#ff9900" height="0">
							<TD style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid; HEIGHT: 24px"><FONT face=" Times New Roman "><STRONG style="COLOR: white"><FONT face=" Times New Roman "><STRONG style="COLOR: white"><p align="center">  Message 
											&nbsp;</FONT></P></STRONG></FONT>
				</STRONG> </FONT></TD></TR>
			<TR bgColor="#eeeeee" height="100%" align="justify">
				<TD valign="top" width="100%" align="left" rowSpan="1"><FONT face=" Times New Roman ">
						<uc1:UCSys id="UCSys1" runat="server"></uc1:UCSys>
					</FONT>
				</TD>
			</TR>
			<TR bgColor="#ff9900" height="0" align="center">
				<TD valign="top" height="0"><FONT face=" Times New Roman " color="#000066" size="2">Email:
						<%=BP.Sys.SystemConfig.ServiceMail%> ,Tel:<%=BP.Sys.SystemConfig.ServiceTel%>.
						<BR>
						<a href="javascript:javascript:window.close(1)" >  Shut down </a>
					</FONT>
				</TD>
			</TR>
			</TBODY>
