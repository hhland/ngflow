...
namespace BP.Web.Comm
{
    ...
    public partial class UIEn : WebPage
    {
        ...
        /// <summary>
        ///  The current collection of entities го
        /// </summary>
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                this.IsReadonly = !uac.IsUpdate;  // Are more changes permissions го
                    ...
                    case NamesOfBtn.Delete:
                        try
                        {
                            ...
                            if (this.PKVal != null)
                                en.PKVal = this.PKVal;
                            en.Delete();
                            this.ToCommMsgPage(" Deleted successfully !!!");
                            return;
                        }
                        catch (Exception ex)
                        {
                            this.ToCommMsgPage(" An error occurred during deletion : \t\n" + ex.Message);
