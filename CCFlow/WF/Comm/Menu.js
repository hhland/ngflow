var  CurrEnsName ; //  The class name £®¡¡ Entity Name £®
var  CurrKeys; //  Foreign key , Primary key , Enumerated type formation  string.
var  WebPath; //  Virtual current virtual directory .
...
function DataCheck( className )
{
  if (CurrEnsName==null)
   ...
   //alert(' Prompt :\\n  Data examination is set for the system administrator or power user , Used to monitor data quality .');
