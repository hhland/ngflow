...
namespace CCFlow.WF.CCForm
{
    public partial class FrmPopValDir : BP.Web.WebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Pub1.AddFieldSet(" Configuration error "," Packet data source is empty :"+sqlGroup);
                return;
            }
            ...
            if (dtObjs.Rows.Count == 0)
                this.Pub1.AddFieldSet(" Configuration or data source error ", " Query entity Is empty :" + sqlObjs);
        }
        ...
        protected void Btn_OK_Click(object sender, EventArgs e)
        {
            ...
            foreach (Control ctl in this.Pub1.Controls)
            {
                ...
                switch (popValFormat)
                {
                    case 0:  // Only the number 
                        val += "," + cb.ID.Replace("CB_", "");
                        break;
                    case 1: //  Name Only 
                        val += "," + text;
                        break;
                    case 2: //  Number and name 
