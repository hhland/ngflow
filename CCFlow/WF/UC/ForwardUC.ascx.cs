...
namespace CCFlow.WF.UC
{
    public partial class Forward_UC : BP.Web.UC.UCBase3
    {
        ...
        {
            this.ToolBar1.AddBtn(NamesOfBtn.Forward, " Transfer ");
            //  if (this.IsEUI == false)
            //{
            this.ToolBar1.AddBtn(NamesOfBtn.Cancel, " Cancel ");
            this.ToolBar1.GetBtnByID(NamesOfBtn.Forward).Attributes["onclick"] = " return confirm(' Are you sure you want to perform ?');";
            ...
            this.ToolBar1.AddLab("ds", "&nbsp; Please choose the transfer of people , Enter the reason for the transfer , Point transfer button to execute the handover of work .");
        ...
        void Forward_Click(object sender, EventArgs e)
        {
            ...
            switch (btn.ID)
            {
                case NamesOfBtn.Cancel:
                    this.Response.Redirect("../MyFlow" + BP.WF.Glo.FromPageType + ".aspx?FK_Node=" + this.FK_Node + "&FK_Flow=" + this.FK_Flow + "&WorkID=" + this.WorkID + "&FID=" + this.FID, true);
            ...
            try
            {
                ...
                if (msg == " Please enter a reason for the transfer ...")
                    throw new Exception("@ You must enter a reason for the transfer .");
                ...
                if (toEmp == "")
                {
                    this.Alert(" Please select the person you want to transfer .");
                    return;
                }
            ...
            catch (Exception ex)
            {
                ...
                this.Alert(" Job transfer error :" + ex.Message);
            }
        }
        /// <summary>
        ///  Binding 
