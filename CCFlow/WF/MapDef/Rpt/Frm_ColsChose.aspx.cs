...
namespace CCFlow.WF.MapDef.Rpt
{
    public partial class Frm_ColsChose : BP.Web.PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Pub1.AddCaptionLeft(" Please select the fields you want to display , Then click the Save button .");
            ...
            int cols = 4; // Define the number of columns displayed  从0 Begin .
            int idx = -1;
            bool is1 = false;
        ...
        void cbAll_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (cbAll != null)
            {
                ...
                if (cbAll.Checked)
                {
                    // All properties query form 
                    MapAttrs mattrs = new MapAttrs(this.FK_MapData);
                    //OID Default must have 
                    ...
                    reportFieldPK.Name = " Serial number ";
