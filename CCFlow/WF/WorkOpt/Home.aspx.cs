...
public partial class WF_WorkOpt_Home : System.Web.UI.Page
{
    ...
    {
        this.Pub2.AddFieldSet(" Process Overview ");
        ...
        this.Pub2.AddTR();
        this.Pub2.Add("<TD colspan=1 class=ToolBar  > Process Name :" + fl.Name + "</TD>");
        this.Pub2.AddTREnd();
        ...
        foreach (BP.WF.Node nd in nds)
        {
            ...
            foreach (GenerWorkerList wl in wls)
            {
                if (wl.FK_Node == nd.NodeID)
                {
                    ...
                    //this.Pub2.Add("<BR> Executor :" + wl.FK_EmpText);
                    ...
                    //this.Pub2.Add("<a href='WFRpt.aspx?WorkID=" + wl.WorkID + "&FID=0&FK_Flow=" + this.FK_Flow + "' target=_blank > Detailed ..</a><hr>");
                    isHave = true;
                    break;
                }
            }
