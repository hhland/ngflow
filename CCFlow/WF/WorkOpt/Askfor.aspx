<%@ Page Title=" Plus sign " Language="C#" MasterPageFile="../SDKComponents/Site.Master" AutoEventWireup="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowIt(tb, hid) {
            ...
            if (emparr.length > 1) {
                alert(' People enter endorsement （' + arr[1] + '） Incorrect , Plus sign can only choose one , Please reselect !');
                return;
            }
