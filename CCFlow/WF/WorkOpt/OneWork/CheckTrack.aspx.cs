...
namespace ShenZhenGovOA.WF.WorkOpt.OneWork
{
    public partial class CheckTrack : System.Web.UI.Page
    {
        ...
        public void FreeModel()
        {
            ...
            //    this.Pub2.Add(" Cc :" + cl.Rec + ",  Cc date :" + cl.RDT);
            //    this.Pub2.AddHR();
        ...
        public void TableMode()
        {
            ...
            this.Pub2.AddTDTitle(" Date Time ");
            this.Pub2.AddTDTitle(" From node ");
            this.Pub2.AddTDTitle(" Staff ");
            this.Pub2.AddTDTitle(" To node ");
            this.Pub2.AddTDTitle(" Staff ");
            this.Pub2.AddTDTitle(" Activity ");
            this.Pub2.AddTDTitle(" Information ");
            this.Pub2.AddTDTitle(" Form ");
            this.Pub2.AddTDTitle(" Executor ");
            this.Pub2.AddTREnd();
            ...
            foreach (DataRowView dr in dv)
            {
                ...
                this.Pub2.AddTD("<a href=\"javascript:WinOpen('" + BP.WF.Glo.CCFlowAppPath + "WF/WFRpt.aspx?WorkID=" + dr[TrackAttr.WorkID].ToString() + "&FK_Flow=" + this.FK_Flow + "&FK_Node=" + dr[TrackAttr.NDTo].ToString() + "&DoType=View&MyPK=" + dr[TrackAttr.MyPK].ToString() + "','" + dr[TrackAttr.MyPK].ToString() + "');\"> Form </a>");
