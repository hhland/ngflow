...
namespace CCFlow.WF.Rpt
{
    public partial class WF_Rpt_Attachment : BP.Web.WebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count == 0)
            {
                this.Pub1.AddMsgInfo(" Prompt ", " The current process is no data , Or that the process has no attachment .");
                return;
            }

            this.Pub1.AddTable();
            this.Pub1.AddCaptionLeft(" Process Accessories ");
            this.Pub1.AddTR();
            this.Pub1.AddTDTitle("IDX");
            this.Pub1.AddTDTitle(" Annex No. ");
            this.Pub1.AddTDTitle(" Name ");
            this.Pub1.AddTDTitle(" Size (kb)");
            this.Pub1.AddTDTitle(" Upload people ");
            this.Pub1.AddTDTitle(" Uploaded ");
            this.Pub1.AddTREnd();
            int i = 0;
