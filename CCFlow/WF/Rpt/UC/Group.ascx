...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div data-options="region:'west',title:' Grouping criteria '" style="padding: 5px; width: 200px;">
        <div class="easyui-panel" title=" Display content " style="padding: 5px; margin-bottom:5px">
            <asp:CheckBoxList ID="CheckBoxList1" BorderStyle="None" Width="100%" runat="server"
                AutoPostBack="true">
            </asp:CheckBoxList>
        </div>
        <div class="easyui-panel" title=" Analysis Project " style="padding: 5px; margin-bottom:5px">
            <uc1:UCSys ID="UCSys2" runat="server"></uc1:UCSys>
        </div>
        <div class="easyui-panel" title=" Chart " style="padding: 5px; margin-bottom:5px">
            <table class="Table" cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                <tr>
                    <td colspan="2">
                        <asp:CheckBox ID="CB_IsShowPict" runat="server" Text=" Show Graph " AutoPostBack="true" 
                            ToolTip=" Watch out : Only when [ Display content ] Choose 1 When items , Charting capabilities available !" />
                    </td>
                </tr>
                <tr>
                    <td style="width:80px">
                ...
                <tr>
                    <td colspan="2" style="text-align:right">
                        <asp:LinkButton ID="lbtnApply" runat="server" CssClass="easyui-linkbutton" 
                            data-options="iconCls:'icon-ok'" onclick="lbtnApply_Click"> Application </asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
