<%@ Page Language="C#" AutoEventWireup="true" Inherits="AppDemo_Lef1t123" Codebehind="Left.aspx.cs" %>
...
--%>
                    ...
                    <li runat="server" id="end" style=" background:url(Img/Menu/Setting.jpg) -1px 0px"><a  href="SysFunc.aspx" target="main"> System Maintenance  </a></li>

                    <li runat="server" id="Li4" style=" background:url(Img/Menu/Setting.jpg) -1px 0px"><a  href="/WF/Tools.aspx" target="main"> Set up  </a></li>
