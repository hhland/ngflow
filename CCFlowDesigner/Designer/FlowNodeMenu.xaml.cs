...
namespace BP
{
    public partial class FlowNodeMenu : UserControl
    {
        ...
        public void ShowMenu()
        {
            ...
            #endregion
            #region  Start node can not be deleted 
            ...
            #endregion
            #region  Non-flow allowed to edit the node icon icon 
        ...
        ///  Restore the node type display shortcuts 
        ...
        private void Menu_ItemSelected(object sender, MenuEventArgs e)
        {
            ...
            switch (e.Tag.ToString())
            {
                ...
                #region
                case "menuExp": //  Export / Share : Process Template 
                    BP.Frm.FrmExp exp = new BP.Frm.FrmExp();
                    exp.Show();
                    break;
                case "menuImp": //   Importing / Find : Process Template 
        ...
        private void delete()
        {
            ...
            {
                if (HtmlPage.Window.Confirm(" You sure you want to delete a node it ?"))
                {
                    this.Visibility = Visibility.Collapsed;
                    IElement iel;
