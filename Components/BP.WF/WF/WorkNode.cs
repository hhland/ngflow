...
namespace BP.WF
{
    ...
    public class WorkNode
    {
        ...
        private GenerWorkerLists WorkerListWayOfDept(WorkNode town, DataTable dt, Int64 fid)
        {
            ...
            {
                string info = "共(" + this.HisWorkerLists.Count + ") People receive \t\n";
                foreach (GenerWorkerList wl in this.HisWorkerLists)
                {
...
#warning  Logging .
        ...
        private void NodeSend_11(Node toND)
        {
            ...
            {
                if (WebUser.IsWap)
                    this.addMsg(SendReturnMsgFlag.AllotTask, null, "<a href=\"" + this.VirPath + "WF/WorkOpt/AllotTask.aspx?WorkID=" + this.WorkID + "&NodeID=" + toND.NodeID + "&FK_Flow=" + toND.FK_Flow + "')\"><img src='" + VirPath + "WF/Img/AllotTask.gif' border=0/> Specify a particular officers dealing </a>.", SendReturnMsgType.Info);
                else
                    this.addMsg(SendReturnMsgFlag.AllotTask, null, "<a href=\"javascript:WinOpen('" + VirPath + "WF/WorkOpt/AllotTask.aspx?WorkID=" + this.WorkID + "&NodeID=" + toND.NodeID + "&FK_Flow=" + toND.FK_Flow + "')\"><img src='" + VirPath + "WF/Img/AllotTask.gif' border=0/> Specify a particular officers dealing </a>.", SendReturnMsgType.Info);
            }
            ...
            if (this.HisNode.HisFormType != NodeFormType.SDKForm)
            {
                ...
                {
                    if (WebUser.IsWap)
                        this.addMsg(SendReturnMsgFlag.ToEmpExt, null, "@<a href='" + VirPath + "WF/Wap/MyFlowInfo" + Glo.FromPageType + ".aspx?DoType=UnSend&WorkID=" + this.HisWork.OID + "&FK_Flow=" + toND.FK_Flow + "'><img src='" + VirPath + "WF/Img/UnDo.gif' border=0/> Revocation of this transmission </a>, <a href='" + VirPath + "WF/Wap/MyFlow" + Glo.FromPageType + ".aspx?FK_Flow=" + toND.FK_Flow + "&FK_Node=" + toND.FK_Flow + "01'><img src='" + VirPath + "WF/Img/New.gif' border=0/> New Process </a>.", SendReturnMsgType.Info);
                    else
                        this.addMsg(SendReturnMsgFlag.ToEmpExt, null, "@<a href='" + this.VirPath + this.AppType + "/MyFlowInfo" + Glo.FromPageType + ".aspx?DoType=UnSend&WorkID=" + this.HisWork.OID + "&FK_Flow=" + toND.FK_Flow + "'><img src='" + VirPath + "WF/Img/UnDo.gif' border=0/> Revocation of this transmission </a>, <a href='" + VirPath + "WF/MyFlow" + Glo.FromPageType + ".aspx?FK_Flow=" + toND.FK_Flow + "&FK_Node=" + toND.FK_Flow + "01'><img src='" + VirPath + "WF/Img/New.gif' border=0/> New Process </a>.", SendReturnMsgType.Info);
                }
                else
                    this.addMsg(SendReturnMsgFlag.ToEmpExt, null, "@<a href='" + this.VirPath + this.AppType + "/MyFlowInfo" + Glo.FromPageType + ".aspx?DoType=UnSend&WorkID=" + this.HisWork.OID + "&FK_Flow=" + toND.FK_Flow + "'><img src='" + VirPath + "WF/Img/UnDo.gif' border=0/> Revocation of this transmission </a>.", SendReturnMsgType.Info);
            }
            ...
            {
                this.addMsg(SendReturnMsgFlag.WorkRpt, null, "@<img src='" + VirPath + "WF/Img/Btn/PrintWorkRpt.gif' ><a href='" + VirPath + "WF/WFRpt.aspx?WorkID=" + this.HisWork.OID + "&FID=" + this.HisWork.FID + "&FK_Flow=" + toND.FK_Flow + "'target='_blank' > Work trajectory </a>.");
            }
            this.addMsg(SendReturnMsgFlag.WorkStartNode, "@ Next [" + toND.Name + "] Work starts successfully .", "@ Next <font color=blue>[" + toND.Name + "]</font> Work starts successfully .");
            #endregion
        ...
        private void NodeSend_24_SameSheet(Node toNode)
        {
            ...
            if (this.HisNode.IsStartNode)
            {
                if (gwls.Count >= 2 && this.HisNode.IsTask)
                    this.addMsg("AllotTask", "@<img src='" + VirPath + "WF/Img/AllotTask.gif' border=0 /><a href=\"javascript:WinOpen('" + VirPath + "WF/WorkOpt/AllotTask.aspx?WorkID=" + this.WorkID + "&FID=" + this.WorkID + "&NodeID=" + toNode.NodeID + "')\" > Modify accept object </a>.");
            }

            if (this.HisNode.IsStartNode)
            {
                if (WebUser.IsWap)
                    this.addMsg("UnDoNew", "@<a href='" + VirPath + "WF/Wap/MyFlowInfo" + Glo.FromPageType + ".aspx?DoType=UnSend&WorkID=" + this.WorkID + "&FK_Flow=" + toNode.FK_Flow + "'><img src='" + VirPath + "WF/Img/UnDo.gif' border=0/> Revocation of this transmission </a>, <a href='" + VirPath + "WF/Wap/MyFlow" + Glo.FromPageType + ".aspx?FK_Flow=" + toNode.FK_Flow + "&FK_Node=" + toNode.FK_Flow + "01' ><img src='" + VirPath + "WF/Img/New.gif' border=0/> New Process </a>.");
                else
                    this.addMsg("UnDoNew", "@<a href='" + this.VirPath + this.AppType + "/MyFlowInfo" + Glo.FromPageType + ".aspx?DoType=UnSend&WorkID=" + this.WorkID + "&FK_Flow=" + toNode.FK_Flow + "'><img src='" + VirPath + "WF/Img/UnDo.gif' border=0/> Revocation of this transmission </a>, <a href='" + this.VirPath + this.AppType + "/MyFlow" + Glo.FromPageType + ".aspx?FK_Flow=" + toNode.FK_Flow + "&FK_Node=" + toNode.FK_Flow + "01' ><img src='" + VirPath + "WF/Img/New.gif' border=0/> New Process </a>.");
            }
            else
            {
                this.addMsg("UnDo", "@<a href='" + this.VirPath + this.AppType + "/MyFlowInfo" + Glo.FromPageType + ".aspx?DoType=UnSend&WorkID=" + this.WorkID + "&FK_Flow=" + toNode.FK_Flow + "'><img src='" + VirPath + "WF/Img/UnDo.gif' border=0/> Revocation of this transmission </a>.");
            }

            this.addMsg("Rpt", "@<a href='" + VirPath + "WF/WFRpt.aspx?WorkID=" + this.WorkID + "&FID=" + wk.FID + "&FK_Flow=" + this.HisNode.FK_Flow + "'target='_blank' > Work trajectory </a>");
