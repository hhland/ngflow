    ...
    public class NodeSheet : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                //    " Whether to enable shared task pool (”Îweb.config The IsEnableTaskPool Configuration is enabled to be effective , Nothing to do with the child thread )?", true, true, true);
       ...
       true, true, NodeAttr.WhenNoWorker, "@0= An error @1= Automatically go to the next step ");
          ...
          true, true, BtnAttr.SelectAccepterEnable);
                ...
                map.AddTBFloat(NodeAttr.DeductDays, 1, " Deadline (days)", true, false); //" Deadline (ÃÏ)"
