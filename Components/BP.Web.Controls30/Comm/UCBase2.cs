...
namespace BP.Web.UC
{
    ...
    public class UCBase2 : BP.Web.UC.UCBase
    {
        ...
        #region ”Î entity  Related operations 
        /// <summary>
        ///  Setting Data 
        /// </summary>
        /// <param name="en"></param>
        public void SetCtrlValues(Entity en)
        {
            ...
            {
                #region  Exclude non-scheduled control 
                ...
                #endregion  Exclude non-scheduled control 

                #region  Set the control information .
                ...
                #endregion  Set the control information .
            }
        }
        ...
        //    this.AddTable("width=90%");
            ...
            foreach (Attr attr in attrs)
            {
                ...
                if (attr.UIIsLine)
                {
                    ...
                    isLeft = true;
                    isAddTR = true; /* Let him next time from 0 Begin .*/
                    if (attr.UIHeight != 0)
                    {
                    ...
                    {
                        if (val.ToString() == "1")
                            this.AddAttrDescVal("", "<b> «</b> " + attr.Desc, 3);
                        else
                            this.AddAttrDescVal("", "<b>∑Ò</b> " + attr.Desc, 3);
                    }
                    else
                ...
                switch (attr.UIContralType)
                {
                    ...
                    case UIContralType.CheckBok:
                        if (en.GetValBooleanByKey(attr.Key))
                            this.AddAttrDescVal(attr.Desc, " «", 1);
                        else
                            this.AddAttrDescVal(attr.Desc, "∑Ò", 1);
                        break;
                    default:
                        break;
                }
        ...
        #region table  The default style .
        /// <summary>
        /// 
        /// </summary>
