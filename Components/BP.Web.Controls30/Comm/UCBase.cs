...
namespace BP.Web.UC
{
    ...
    public class UCBase : System.Web.UI.UserControl
    {
        ...
        protected string ExportDGToExcel(System.Data.DataTable dt, string title)
        {
            ...
            // Delete the original file the same name , Otherwise, when downloading , Downloadable content will cause some distortion  added by liuxc,2014-11-3
        ...
        ///  Copy a new  Entities .
        /// </summary>
        /// <param name="ens"> Contains data Ens</param>
        /// <returns></returns>
        ...
        public Entity Copy(Entity en, string pk, Map map)
        {
            ...
            foreach (System.Web.UI.Control ctl in this.Controls)
            {
                ...
                #endregion  Deal with textbox.

                #region  Deal with ddl.
                ...
                #endregion  Deal with ddl.

                #region  Deal with  checkbox
                    ...
                    case UIContralType.RadioBtn:
                        if (attr.IsEnum)
                        {
                            ...
                            foreach (SysEnum se in ses)
                            {
                                ...
                                #region  If it is empty , It is possible that the tag  rb  However, it uses ddl  Displayed .
                                if (rb == null)
                                {
                                    ctlid = "DDL_" + attr.Key + pk;
        ...
        public void BindCard(Entity en, string tableClass)
        {
            ...
            {
                this.AddMsgOfWarning(" Prompt ", " You do not have permissions to view this data .");
                return;
            }
        ...
        /// <summary>
        ///  Use EasyUI The easyui-pagination Pagination Pagination components 
        /// <para></para>
        /// <para> Watch out : This method requires the introduction page easyui Library to be effective </para>
        /// <para>added by liuxc,2014-11-3</para>
        /// </summary>
        /// <param name="totalRecords"> Total number of records </param>
        /// <param name="pageSize"> The number of records per page </param>
        /// <param name="pageIdx"> Current page </param>
        /// <param name="url"> Flip when transit URL</param>
        /// <param name="layout"> Pagination layout , This setting, please refer to EasyUi Described in [EasyUI v1.3.5 Later versions support this property ]
        /// <para></para>
        /// <para> Formats such as :'list','sep','first','prev','sep','manual','sep','next','last','sep','refresh'</para>
        /// <para>1) list:  Display a list of the number of pages [10,20,30,50].</para>
        /// <para>2) sep:  Delimiter .</para>
        /// <para>3) first:  First page .</para>
        /// <para>4) prev:  Previous .</para>
        /// <para>5) next:  After a .</para>
        /// <para>6) last:  Last .</para>
        /// <para>7) refresh:  Refresh button .</para>
        /// <para>8) manual:  Allows the user to enter the page number of the text box .</para>
        /// <para>9) links:  Show 10 A page link .</para>
        /// </param> 
        /// <param name="showParentPanel"> Whether to display pagination outer easyui-panel</param>
        ...
        /// <param name="pageSize"> Leaf size </param>
        /// <param name="PageIdx"></param>
        /// <param name="url"></param>
        /// <returns> Returns the maximum number of pages </returns>
        public int BindPageIdx(int recNum, int pageSize, int PageIdx, string url, int pageSpan)
        {
            ...
            {
                myidx = PageIdx - 1;
                this.Add("<a href='" + url + "&PageIdx=1' >¡¶¡¶¡ª</a> <a href='" + url + "&PageIdx=" + myidx + "'>¡¶¡ª</a>");
            ...
            int pageNum = 0;
            decimal pageCountD = decimal.Parse(recNum.ToString()) / decimal.Parse(pageSize.ToString()); //  Number of pages .
            ...
            decimal spanTemp = decimal.Parse(PageIdx.ToString()) / decimal.Parse(pageSpan.ToString()); //  Number of pages .
        ...
        public int BindPageIdx_ver1(int recNum, int pageSize, int PageIdx, string url)
        {
            ...
            if (PageIdx <= 1)
            {
                this.Add("<div class=PageIdx><li href=#> Home </li> <li href=#> Previous </li>");
            ...
            else
            {
                ...
                this.Add("<div class=PageIdx><li><a href='" + url + "&PageIdx=1'> Home </a></li> <li><a href='" + url + "&PageIdx=" + myidx + "'> Previous </a></li>");
            }
            ...
            {
                myidx = PageIdx + 1;
                // this.Add("&nbsp;<a href='" + url + "&PageIdx=" + myidx + "'><img src='/WF/Img/Page_Down.gif' border=0 /></a>&nbsp;µÚ" + PageIdx + "/" + pageNum + "Ò³");
        ...
        public TB GetTBByID(string key)
        {
            ...
            {
                throw new Exception(ex.Message + "  Please confirm :TB AND TextBox " + key);
            }
        }
        ...
        protected void ResponseWriteRedMsg(string msg)
        {
            ...
            this.WinOpen(url, " Caveat ", "msg", 500, 400, 150, 270);
        }
        ...
        protected void ResponseWriteBlueMsg(string msg)
        {
            ...
            this.WinOpen(url, " Error Messages ", "msg", 500, 400, 150, 270);
        }
        /// <summary>
        ///  Saved successfully 
        /// </summary>
