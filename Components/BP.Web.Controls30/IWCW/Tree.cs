...
namespace BP.Web.Controls
{
    ...
    {
        /// <summary>
        ///  The selected node , Are set to sql Mode .
        /// </summary>
        ...
        /// <summary>
        ///  Get selected  SelfNo  According division symbol .
        /// </summary>
        /// <param name="spt"> Split Symbols </param>
        ...
        /// <summary>
        /// OID, No , Name .  Is not it  CheckBox
        /// </summary>
        /// <param name="dt"></param>
        ...
        //		/ <summary>
        //		/  User Functions ,  Modified on  2003-10-21
        //		/ </summary> 
	...
	public class Node : Microsoft.Web.UI.WebControls.TreeNode 
	{
		...
		/// <summary>
		///  Tree node unique identification OID
		/// </summary>
		public int SelfOID
		{
			get 
