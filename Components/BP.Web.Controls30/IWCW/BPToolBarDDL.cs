...
namespace BP.Web.Controls
{
	...
	public class ToolbarDDL : Microsoft.Web.UI.WebControls.ToolbarDropDownList
	{
		...
		///  
		/// </summary>
		/// <param name="val"> To be removed key.</param>
        ...
        /// <summary>
        ///  Setting select items 
        /// </summary>
        /// <param name="val"></param>
        /// <returns> Whether the selected item </returns>
		...
		public void SelfBindSysEnum()
		{
			...
			if (dt.Rows.Count==0)
				throw new Exception("@ No pre-enumeration type :"+this.SelfBindKey);
...
//					break;
		...
		{
			this.Items.Clear();
			this.Items.Add( new ListItem(" First quarter ","01"));
			this.Items.Add( new ListItem(" Second quarter ","04"));
			this.Items.Add( new ListItem(" The third quarter ","07"));
			this.Items.Add( new ListItem(" Fourth quarter ","10"));
		...
		/// <param name="isShowKey"> Whether to display the coding </param>
		/// <param name="local">all Location </param>
        ...
        public void BindEntities(Entities ens, string refkey, string reftext, bool isShowKey, bool isClearItems, AddAllLocation where)
        {
           ...
           /// #warning  Deal with the problem more choice 
		...
		/// <summary>
		///  According to an entity set up a Entity 
		/// </summary>
		/// <param name="ens">ens</param>
		/// <param name="refkey">refkey</param>
		/// <param name="reftext">reftext</param>
