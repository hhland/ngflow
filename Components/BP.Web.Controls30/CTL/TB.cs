...
namespace BP.Web.Controls
{
    ...
    public class TB : System.Web.UI.WebControls.TextBox
    {
        ...
        #region  Deal with  DataHelpKey  Extended Attributes 
        /// <summary>
        ///  Helping Key. 
        ///  For ens  Help 
        /// </summary>
        ...
        #region  Ordinary extended attributes 
        /// <summary>
        ///  The goal 
        /// </summary>
        public object Tag
        ...
        public TBType ShowType
        {
            ...
            set
            {
                ...
                switch (_ShowType)
                {
                    case TBType.Ens: // If it is to be developed Ens.
                        ...
                        //this.ToolTip=" Advanced Find and select the right health .";
                        break;
                    case TBType.EnsOfMany: // If it is to be developed Ens.
                        //this.Width=Unit.Pixel(this.DefaultWith);
                    ...
                    case TBType.Self:
                        if (this.DataHelpKey == null)
                            throw new Exception("@ You do not have to specify bonding Key.");
                        break;
                    case TBType.Date:
                        this.Columns = 10;
                        this.MaxLength = 20;
                    ...
                    case TBType.TB:
                        if (this.EnsName != null && this.IsHelpKey)
                        {
                            ...
                            this.Attributes["onmousedown"] = script;
                            //this.ToolTip=" Choose the right health or set to define default values .";
                        }
                        if (this.ReadOnly)
                        {
        ...
        #region  Handle different types of values ( At page rendering time )
        ...
        #region  Remove the extended attributes £¨ For easy access to information £©
        /// <summary>
        ///  Remove the expansion TextExt Property 
        /// </summary>
        ...
        /// <summary>
        ///  Remove the expansion Int Property 
        /// </summary>
        ...
        /// <summary>
        ///  Remove the expansion Float Property 
        /// </summary>
        ...
        /// <summary>
        ///  Remove the expansion Decimal Property 
        /// </summary>
        ...
        /// <summary>
        ///  Remove the extension date property 
        /// </summary>
