...
{ 
    ...
    public class Para
    {
        ...
        public System.Data.OracleClient.OracleType DATypeOfOra
        {
            get
            {
                switch (this.DAType)
                {
                    ...
                    default:
                        throw new Exception(" Types not covered .typeof(obj)=" + this.DAType.ToString());

                       // throw new Exception(" Types not covered .typeof(obj)=");
                }
            }
        }
        ...
        /// </summary>
        /// <param name="_paraName"> Parameter name </param>
	...
	public class Paras : System.Collections.CollectionBase
    {
        ...
        public void Add(string _name, object obj)
        {
            ...
            if (obj == null)
                throw new Exception("@ Parameters :" + _name + "  Invalid value .");
            ...
            if (obj == DBNull.Value)
                ...
                throw new Exception("@ Does not determine the type of the parameter :" + _name);
            //     this.Add(_name, obj.ToString());
        }
