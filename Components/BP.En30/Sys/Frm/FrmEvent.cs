        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLSysEnum(FrmEventAttr.MsgCtrl, 0, " Messaging control ", true, true, FrmEventAttr.MsgCtrl,
                    "@0= Do not send @1= Automatic by sending the set range @2= The nodes form system by field (IsSendEmail,IsSendSMS) To decide @3=由SDK Developers parameters (IsSendEmail,IsSendSMS) To decide ", true);
                ...
                map.AddBoolean(FrmEventAttr.MobilePushEnable, true, " If pushed to your phone ,pad端.", true, true, true);
