...
namespace BP.Sys
{
	...
	public class SysDocFile : EntityMyPK
	{
        ...
        public string DocText
        {
            ...
            set
            {
                ...
                while (true)
                {
                    ...
                    if (i > 20)
                        throw new Exception(" Much less than the data storage .");
                }
            }
        }
        public string D1
        ...
        /// <summary>
        ///  Note that the data is not initialized .
        /// </summary>
		...
		public override Map EnMap
		{
            get
            {
                ...
                map.EnDesc = " Memo field file manager ";
               // map.DepositaryOfEntity = Depositary.Application;
                map.DepositaryOfMap = Depositary.Application;
                map.AddMyPK();

                map.AddTBString(SysDocFileAttr.FileName, null, " Name ", false, true, 0, 200, 30);
                map.AddTBInt(SysDocFileAttr.FileSize, 0, " Size ", true, true);
                map.AddTBString(SysDocFileAttr.FileType, null, " File Type ", true, true, 0, 200, 20);
