...
namespace BP.Port
{
    ...
    public class DeptStation : Entity
    {
        ...
        /// </summary>
        /// <param name="FK_Dept"> Department </param>
        /// <param name="FK_Station"> Job numbers </param> 	
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBStringPK(DeptStationAttr.FK_Dept, null, " Department ", false, false, 1, 15, 1);
