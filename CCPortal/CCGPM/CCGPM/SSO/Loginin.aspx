...
<%@ Page Language="c#" Inherits="BP.Web.Loginin" CodeBehind="Loginin.aspx.cs" %>
                ...
                <td class="style1">
                 &nbsp;&nbsp;<cc1:Lab ID="Lab1" runat="server">
                  ...
                  <cc1:TB ID="TB_No"  runat="server" ShowType="TB"
                                Width="165px" Height="28px" Font-Bold="true" Font-Size="14px"></cc1:TB>
                </td>
               </tr>
               <tr>
                <td class="style5">
                  ...
                  <cc1:TB ID="TB_Pass" runat="server"
                                Width="164px" Height="28px" BorderStyle="none" TextMode="Password" Font-Bold="true" Font-Size="14px" ></cc1:TB>
