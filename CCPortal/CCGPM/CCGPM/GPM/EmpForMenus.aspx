...
<body class="easyui-layout">
    ...
    <div data-options="region:'north',border:false" style="height: 40px; background: #E0ECFF;
        ...
        <div class="toolbar">
            ...
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="QueryEmps()">
                查询</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="#" id="saveRight" class="easyui-linkbutton"
                    data-options="plain:false,iconCls:'icon-save',disabled:true">保存</a>
            <%--<a href="#" class="easyui-linkbutton">清除权限</a>--%>
            <a href="#" id="rightC" class="easyui-linkbutton" onclick="CopyRight()">复制权限到其他人</a>
        </div>
    </div>
