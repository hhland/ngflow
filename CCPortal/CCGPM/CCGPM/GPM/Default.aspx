    ...
    <div region="north" border="true" class="cs-north">
        <div class="cs-north-bg">
            ...
            <div class="l-topmenu-welcome">
                <span class="space">
                    <%=usermsg %></span>&nbsp;&nbsp;<span class="space">|</span>&nbsp;&nbsp;<a class="space"
                        href="Exit.aspx">注销</a> <span class="space">|</span> <a href="http://bbs.ccflow.org/"
                            class="space" target="_blank">论坛</a>
            </div>
        </div>
    </div>
