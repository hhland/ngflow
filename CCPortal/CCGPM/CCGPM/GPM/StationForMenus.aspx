...
<body class="easyui-layout">
    ...
    <div data-options="region:'north',border:false" style="height: 40px; background: #E0ECFF;
        padding: 10px">
        <div class="toolbar">
            查询内容：<input type="text" id="searchContent" name="searchContent" />
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" id="QueryStation"> 查询</a> 
            &nbsp;&nbsp;&nbsp;&nbsp; 
            <a href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'icon-save',disabled:true" id="saveRight">保存</a>
            <%--<a href="#" class="easyui-linkbutton">清除权限</a>--%>
            <a href="#" id="rightC" class="easyui-linkbutton" onclick="CopyRight()">复制权限到其他岗位</a>
        </div>
    </div>
