...
<body class="easyui-layout">
    ...
    <div data-options="region:'north',border:false" style="height:40px;background:#E0ECFF;padding:10px">
        <div class="toolbar">
		    查询内容：<input type="text" id="searchConten" name="searchConten" />
		    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="QueryEmpGroups()">查询</a>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#" id="saveRight" class="easyui-linkbutton" data-options="plain:false,iconCls:'icon-save',disabled:true">保存</a>  
            <%--<a href="#" class="easyui-linkbutton">清除权限</a>--%>
            <a href="#" id="rightC" class="easyui-linkbutton" onclick="CopyRight()">复制权限到其他组</a>
	    </div>
    </div>
