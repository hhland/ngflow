...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchEUIReadOnly.aspx.cs" Inherits="CCOA.Comm.SearchEUIReadOnly" %>
...
<head runat="server">
    ...
    <script src="JS/SearchEasyUIReadOnly.js" type="text/javascript"></script>
</head>
<body class="easyui-layout">
    ...
    <div data-options="region:'center'" style="padding: 0px;" border="false"
        ...
        <div id="tb" style="padding: 3px;">
            <div runat="server" style="height:30px;">
                ...
                <%--只读的--%>
                  <a id="checkWin" href="#" style="float:left;" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-mulu'"
                    onclick="CheckEntityForm()">查看</a> 
