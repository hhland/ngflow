...
{
   var url1= "/Comm/"+'UIEn.aspx?EnName='+className+url;
...
{
   var url1= "/Comm/"+'Item3.aspx?EnName='+className+url;
   var newWindow=window.open( url1,'card', 'width=700,top=50,left=50,height=500,scrollbars=yes,resizable=yes,toolbar=false,location=false' );
   newWindow.focus();
   return;
}
...
{
    var url = ''; // appPath+"/Comm/RefFunc/DataHelp.htm?HelperOfDDL.aspx?EnsName="+EnsName+"&RefKey="+refkeyvalue+"&RefText="+reftext;
   if ( appPath=='/')
       url = "RefFunc/DataHelp.htm?HelperOfDDL.aspx?EnsName=" + EnsName + "&RefKey=" + refkeyvalue + "&RefText=" + reftext;
     else
...
{
     var url='';
     url = "RefFunc/DataHelp.htm?HelperOfDDL.aspx?EnsName=" + EnsName + "&RefKey=" + refkeyvalue + "&RefText=" + reftext + "&MainEns=" + MainEns + "&DDLID=" + ddlID;
