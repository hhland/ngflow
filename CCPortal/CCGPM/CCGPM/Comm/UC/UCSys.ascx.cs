...
namespace BP.Web.Comm.UC
{
    ...
    public partial class UCSys : BP.Web.UC.UCBase
    {
        ...
        public void DataPanelDtlEUIHe(Entities ens, string ctrlId)
        {
            ...
            //this.Add("<table title='数据' class='easyui-datagrid' id='tt' style='display: none;' pagination='true' rownumbers='true' iconcls='icon-save' url='" + this.Request.RawUrl + "&type=LoadData' method='post'>");
        ...
        public void DataPanelDtl(Entities ens, string ctrlId)
        {
            ...
            int WinCardH = ens.GetEnsAppCfgByKeyInt("WinCardH", 500); // 弹出窗口高度
            int WinCardW = ens.GetEnsAppCfgByKeyInt("WinCardW", 400); // 弹出窗口宽度
