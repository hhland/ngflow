    ...
    public partial class UCEn : BP.Web.UC.UCBase3
    {
        public static string GetRefstrs(string keys, Entity en, Entities hisens)
        {
            ...
            if (enDtls.Count > 0)
            {
                ...
                {
                    string url =  "/Comm/UIEnDtl.aspx?EnsName=" + enDtl.EnsName + "&RefKey=" + enDtl.RefKey + "&RefVal=" + en.PKVal.ToString() + "&MainEnsName=" + en.ToString();
                    try
                    {
                        try
                        {
                        ...
                        case UIContralType.TB:
                            ...
                            else
                            {
                                ...
                                if (attr.MinLength == 0)
                                    ...
                                    this.AddContral(attr.Desc + "<font color=red><b>*</b></font>", tb, 3);
                            }
                            break;
                                ...
                                case EditerType.None:
                                    ...
                                    else
                                    {
                                        ...
                                        if (attr.MinLength == 0)
                                            ...
                                            this.AddContral(attr.Desc + "<font color=red><b>*</b></font>", area);
                                    }
                                    break;
                                case EditerType.Sina:
                                case EditerType.FKEditer:
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (attr.MinLength == 0)
                                    ...
                                    this.AddContral(attr.Desc + "<font color=red><b>*</b></font>", tb);
